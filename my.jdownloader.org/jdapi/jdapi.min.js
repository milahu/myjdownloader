...
define("coreCore", ["coreCrypto", "coreCryptoUtils", "coreRequest", "coreRequestHandler"], function (a, b, c, d) {
  ...
  if (window.location.protocol === "https:" || window.location.protocol === "http:") {
    e = window.location.protocol + "//localhost:3128";
    e = window.location.protocol + "//" + window.location.hostname + ":3128";
  } else {
    ...
    e = "https://" + window.location.hostname + ":3128";
  }
...
define("config/config", [], function () {
  return {
    ...
    API_ROOT: "//" + window.location.hostname + ":3128",
